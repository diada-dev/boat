...
;/////////////////////////////////////////////////////////////////////////////////    
OpenWindow(#WINDOW_MAIN, 0, 0, 500, 500, "Save them!!!", #FLAGS)
...
StartPrg:
    If StartDrawing(WindowOutput(#WINDOW_MAIN))
       ...
       DrawText(110, 30, "Lifeguards top:", RGB(Random(255), Random(255), Random(255)),RGB(135, 135, 255)) 
       ...
       DrawText(150, 460 , "Press any key", RGB(Random(255), Random(255), Random(255)),RGB(135, 135, 255)) 
...
Game_cycle:
   ...
   For r = 0 To Random(3)
    ...
    If Random(20) = 0
     ...
     If StartDrawing(WindowOutput(#WINDOW_MAIN))
       ...
       DrawingFont(FontID(9))
       DrawText(10, 460 , "Score: " + Str(Score), RGB(255, 255, 128),RGB(135, 135, 255))
       DrawText(300, 460 , "Shoots: " + Str(Fuel), RGB(255, 255, 128),RGB(135, 135, 255))      
 ...
 Game_pause:
     ...
     If StartDrawing(WindowOutput(#WINDOW_MAIN))
       DrawingFont(FontID(10))
       DrawText(190, 190, "Pause", RGB(Random(255), Random(255), Random(255)),RGB(135, 135, 255)) 
       StopDrawing()
     EndIf
...
Game_end: 
     If Terminate = 1
         TerminteStr.s = "You drowned" 
         TerminateX = 135
     ElseIf Terminate = 2
         TerminteStr.s = "You are killer!!!" 
         TerminateX = 110 
     EndIf
...
name_enter:
        If StartDrawing(WindowOutput(#WINDOW_MAIN))
          DrawingFont(FontID(10))
          DrawText(115, 190, "Input your name", RGB(Random(255), Random(255), Random(255)),RGB(135, 135, 255))
          StopDrawing()
        EndIf
